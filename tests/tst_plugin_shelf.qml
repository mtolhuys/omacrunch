...
FloatingWindow {
  ...
  TestCase {
    ...
    function test_reorder() {
      ...
      // A human drag rarely stays exactly inside a 30px bar. Release 15px
      // below it while the pointer is still grabbed by the arrangement area.
      dragWidget(first, 20, 220, 30)
